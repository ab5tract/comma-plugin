...
import edument.rakuidea.refactoring.inline.variable.RakuInlineVariableActionHandler;
...
public class InlineVariableTest extends CommaFixtureTestCase {
    ...
    private void doTest() {
        ...
        RakuInlineVariableActionHandler action = new RakuInlineVariableActionHandler();
