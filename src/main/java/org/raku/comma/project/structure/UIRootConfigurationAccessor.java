...
public class UIRootConfigurationAccessor extends RootConfigurationAccessor {
    ...
    public Sdk getProjectSdk(final @NotNull Project project) {
        return RakuProjectStructureConfigurable.getInstance(project).getProjectSdksModel().getProjectSdk();
    }
    ...
    public String getProjectSdkName(final @NotNull Project project) {
        ...
        final ProjectSdksModel projectJdksModel = RakuProjectStructureConfigurable.getInstance(project).getProjectSdksModel();
