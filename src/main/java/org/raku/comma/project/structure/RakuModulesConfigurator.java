...
import org.raku.comma.actions.ImportModuleAction;
...
import org.raku.comma.project.structure.ui.HeaderHidingTabbedModuleEditor;
...
public class RakuModulesConfigurator implements ModulesProvider, ModuleEditor.ChangeListener {
    ...
    public static boolean showDialog(@NotNull Project project, @Nullable final String moduleToSelect, @Nullable final String editorNameToSelect) {
        final RakuProjectStructureConfigurable config = RakuProjectStructureConfigurable.getInstance(project);
    ...
    public void apply() throws ConfigurationException {
        ...
        final ProjectSdksModel projectJdksModel = RakuProjectStructureConfigurable.getInstance(myProject).getProjectSdksModel();
