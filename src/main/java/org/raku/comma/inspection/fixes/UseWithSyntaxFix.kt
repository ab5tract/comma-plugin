...
class UseWithSyntaxFix(replaced: String, private val start: Int, private val end: Int) : LocalQuickFix {
    ...
    override fun getName(): String { return "Use '%s' syntax construction".format(replacer) }
    override fun getFamilyName(): String { return "Use equivalent 'with'-style construction" }
}