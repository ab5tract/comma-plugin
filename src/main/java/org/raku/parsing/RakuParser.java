...
public class RakuParser implements PsiParser {
    ...
    private boolean EXPR_2_alt_17(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.FAKE_INFIX) {
    ...
    private boolean EXPR_2_alt_20(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.END_OF_EXPR) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean TOP_4_quant_2(PsiBuilder builder, OPP opp) {
        ...
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.BAD_CHARACTER) && (tt1.equals("}"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean arglist_6_alt_3(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.ARGLIST_EMPTY) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean arglist_6(PsiBuilder builder) {
        ...
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.ARGLIST_START) {
            builder.advanceLexer();
        } else {
            return false;
        }
        ...
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.ARGLIST_END) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean args_7_alt_1(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.NO_ARGS) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean args_7_alt_2(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.WHITE_SPACE) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean args_7_quant_3(PsiBuilder builder, OPP opp) {
        ...
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PARENTHESES_CLOSE) && (tt2.equals(")"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean args_7_alt_4(PsiBuilder builder, OPP opp) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PARENTHESES_OPEN) && (tt1.equals("("))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean args_7_quant_5(PsiBuilder builder, OPP opp) {
        ...
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PARENTHESES_CLOSE) && (tt4.equals(")"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean args_7_alt_6(PsiBuilder builder, OPP opp) {
        ...
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PARENTHESES_OPEN) && (tt3.equals("("))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean assertion_8_alt_1(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_MISSING_ASSERTION) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean assertion_8_alt_4(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_CAPTURE_NAME) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean assertion_8_alt_6(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_ASSERTION_END) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean assertion_8_alt_8(PsiBuilder builder, OPP opp) {
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_INFIX) && (tt1.equals("~~"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean assertion_8_quant_10(PsiBuilder builder, OPP opp) {
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PARENTHESES_CLOSE) && (tt3.equals(")"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean assertion_8_alt_11(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PARENTHESES_OPEN) && (tt2.equals("("))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean assertion_8_alt_12(PsiBuilder builder, OPP opp) {
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.INVOCANT_MARKER) && (tt4.equals(":"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean assertion_8_alt_16(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_ANCHOR) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean assertion_8_alt_18(PsiBuilder builder, OPP opp) {
        ...
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.METHOD_CALL_NAME) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean assertion_8_quant_20(PsiBuilder builder, OPP opp) {
        ...
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PARENTHESES_CLOSE) && (tt6.equals(")"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean assertion_8_alt_21(PsiBuilder builder, OPP opp) {
        ...
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PARENTHESES_OPEN) && (tt5.equals("("))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean assertion_8_alt_22(PsiBuilder builder, OPP opp) {
        ...
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.INVOCANT_MARKER) && (tt7.equals(":"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean assertion_8_alt_23(PsiBuilder builder, OPP opp) {
        ...
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.INFIX) && (tt8.equals("="))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean assertion_8_alt_27(PsiBuilder builder, OPP opp) {
        ...
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_LOOKAROUND) && (tt9.equals("!"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean assertion_8_alt_28(PsiBuilder builder, OPP opp) {
        ...
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_LOOKAROUND) && (tt10.equals("?"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean assertion_8_alt_29(PsiBuilder builder, OPP opp) {
        ...
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.METHOD_CALL_OPERATOR) && (tt11.equals("."))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean atom_9_alt_2(PsiBuilder builder, OPP opp) {
        PsiBuilder.Marker marker2;
        marker2 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STRING_LITERAL_CHAR) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean backslash_11_alt_1(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_BACKSLASH_BAD) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean backslash_11_alt_2(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_BUILTIN_CCLASS) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean bare_complex_number_12(PsiBuilder builder) {
        ...
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.COMPLEX_LITERAL) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean bare_rat_number_13(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.RAT_LITERAL) && (tt1.equals("/"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean blockoid_16_quant_3(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.BLOCK_CURLY_BRACKET_CLOSE) && (tt2.equals("}"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean blockoid_16(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.BLOCK_CURLY_BRACKET_OPEN) && (tt1.equals("{"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean blorst_17_alt_1(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.MISSING_BLORST) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean bogus_end_18(PsiBuilder builder) {
        OPP opp;
        opp = null;
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.BAD_CHARACTER) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean capterm_20_alt_1(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.CAPTURE_INVALID) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean capterm_20_quant_3(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.CAPTURE_TERM) && (tt2.equals(")"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean capterm_20_alt_4(PsiBuilder builder, OPP opp) {
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.CAPTURE_TERM) && (tt1.equals("("))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean capterm_20(PsiBuilder builder) {
        ...
        PsiBuilder.Marker marker1;
        marker1 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.CAPTURE_TERM) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean cclass_elem_22_alt_1(PsiBuilder builder, OPP opp) {
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_CCLASS_SYNTAX) && (tt1.equals("-"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean cclass_elem_22_alt_2(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_CCLASS_SYNTAX) && (tt2.equals("+"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean cclass_elem_22_alt_5(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_CCLASS_INCOMPLETE) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean cclass_elem_22_quant_17(PsiBuilder builder, OPP opp) {
        ...
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_CCLASS_SYNTAX) && (tt4.equals(".."))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean cclass_elem_22_quant_18(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_CCLASS_ATOM) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean cclass_elem_22_alt_21(PsiBuilder builder, OPP opp) {
        String tt5;
        tt5 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_CCLASS_SYNTAX) && (tt5.equals("]"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean cclass_elem_22_alt_22(PsiBuilder builder, OPP opp) {
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_CCLASS_SYNTAX) && (tt3.equals("["))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean circumfix_27_quant_1(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STRING_LITERAL_QUOTE_CLOSE) && (tt2.equals(">"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean circumfix_27_alt_3(PsiBuilder builder, OPP opp) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STRING_LITERAL_QUOTE_OPEN) && (tt1.equals("<"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean circumfix_27_quant_4(PsiBuilder builder, OPP opp) {
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STRING_LITERAL_QUOTE_CLOSE) && (tt4.equals("\u00BB"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean circumfix_27_alt_6(PsiBuilder builder, OPP opp) {
        ...
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STRING_LITERAL_QUOTE_OPEN) && (tt3.equals("\u00AB"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean circumfix_27_quant_7(PsiBuilder builder, OPP opp) {
        String tt6;
        tt6 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STRING_LITERAL_QUOTE_CLOSE) && (tt6.equals(">>"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean circumfix_27_alt_9(PsiBuilder builder, OPP opp) {
        ...
        String tt5;
        tt5 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STRING_LITERAL_QUOTE_OPEN) && (tt5.equals("<<"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean circumfix_27_alt_10(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.BARE_BLOCK) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean circumfix_27_quant_11(PsiBuilder builder, OPP opp) {
        String tt8;
        tt8 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.ARRAY_COMPOSER_CLOSE) && (tt8.equals("]"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean circumfix_27_alt_12(PsiBuilder builder, OPP opp) {
        ...
        String tt7;
        tt7 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.ARRAY_COMPOSER_OPEN) && (tt7.equals("["))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean circumfix_27_quant_13(PsiBuilder builder, OPP opp) {
        String tt10;
        tt10 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PARENTHESES_CLOSE) && (tt10.equals(")"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean circumfix_27_alt_14(PsiBuilder builder, OPP opp) {
        ...
        String tt9;
        tt9 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PARENTHESES_OPEN) && (tt9.equals("("))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean colonpair_29_alt_1(PsiBuilder builder, OPP opp) {
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.COLON_PAIR) && (tt1.equals(":"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean colonpair_29_quant_3(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.COLON_PAIR_HAS_VALUE) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean colonpair_29_alt_4(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.COLON_PAIR) && (tt2.equals(":"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.COLON_PAIR) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean colonpair_29_alt_5(PsiBuilder builder, OPP opp) {
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.COLON_PAIR) && (tt3.equals(":"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean colonpair_29_quant_6(PsiBuilder builder, OPP opp) {
        String tt5;
        tt5 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.COLON_PAIR) && (tt5.equals(")"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean colonpair_29_alt_7(PsiBuilder builder, OPP opp) {
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.COLON_PAIR) && (tt4.equals(":("))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean colonpair_29_alt_8(PsiBuilder builder, OPP opp) {
        String tt6;
        tt6 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.COLON_PAIR) && (tt6.equals(":!"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean colonpair_29_alt_9(PsiBuilder builder, OPP opp) {
        String tt7;
        tt7 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.COLON_PAIR) && (tt7.equals(":"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.INTEGER_LITERAL) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean colonpair_variable_30_alt_2(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.VARIABLE) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean complex_number_32(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.COMPLEX_LITERAL) && (tt1.equals("<"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
        ...
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.COMPLEX_LITERAL) && (tt2.equals(">"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean contextualizer_33_quant_1(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.CONTEXTUALIZER_CLOSE) && (tt2.equals(")"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean contextualizer_33_alt_2(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.CONTEXTUALIZER) {
            builder.advanceLexer();
        } else {
            return false;
        }
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.CONTEXTUALIZER_OPEN) && (tt1.equals("("))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean contextualizer_33_alt_3(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.CIRCUMFIX_CONTEXTUALIZER) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean dec_number_34_alt_1(PsiBuilder builder, OPP opp) {
        PsiBuilder.Marker marker1;
        marker1 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.RAT_LITERAL) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean dec_number_34_alt_2(PsiBuilder builder, OPP opp) {
        ...
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.NUMBER_LITERAL) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean declarator_36_alt_14(PsiBuilder builder, OPP opp) {
        ...
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TERM_DECLARATION_BACKSLASH) && (tt3.equals("\\"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean default_value_37(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.INFIX) && (tt1.equals("="))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean defterm_38(PsiBuilder builder) {
        ...
        PsiBuilder.Marker marker1;
        marker1 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TERM) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean dotty_40(PsiBuilder builder) {
        ...
        PsiBuilder.Marker marker1;
        marker1 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.METHOD_CALL_OPERATOR) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean eat_terminator_42_quant_2(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.EAT_TERMINATOR_HAS_HEREDOC) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean eat_terminator_42_alt_5(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.END_OF_STATEMENT) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean eat_terminator_42_alt_6(PsiBuilder builder, OPP opp) {
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_TERMINATOR) && (tt1.equals(";"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean eat_terminator_42_alt_9(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.END_OF_STATEMENT_STOPPER) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean eat_terminator_42_alt_10(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.END_OF_STATEMENT_MARK) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean eat_terminator_42_alt_11(PsiBuilder builder, OPP opp) {
        ...
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_TERMINATOR) && (tt2.equals(";"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean eat_terminator_42_alt_12(PsiBuilder builder, OPP opp) {
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_TERMINATOR) && (tt3.equals(";"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean fatarrow_47(PsiBuilder builder) {
        ...
        PsiBuilder.Marker marker1;
        marker1 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PAIR_KEY) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean heredoc_49_quant_1(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STRING_LITERAL_QUOTE_CLOSE) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean heredoc_49_quant_2(PsiBuilder builder, OPP opp) {
        PsiBuilder.Marker marker1;
        marker1 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.HEREDOC) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean infix_54_alt_1(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.INFIX) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean infix_54_alt_2(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.COND_OP_INCOMPLETE) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean infix_54_alt_4(PsiBuilder builder, OPP opp) {
        ...
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.INFIX) && (tt2.equals("!!"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean infix_circumfix_meta_operator_55_alt_1(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.HYPER_METAOP_MISSING) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean infix_circumfix_meta_operator_55_alt_2(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.METAOP) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean infix_prefix_meta_operator_56_alt_1(PsiBuilder builder, OPP opp) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.METAOP) && (tt1.equals("Z"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean infix_prefix_meta_operator_56_alt_2(PsiBuilder builder, OPP opp) {
        ...
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.METAOP) && (tt2.equals("X"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean infix_prefix_meta_operator_56_alt_3(PsiBuilder builder, OPP opp) {
        ...
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.METAOP) && (tt3.equals("S"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean infix_prefix_meta_operator_56_alt_7(PsiBuilder builder, OPP opp) {
        ...
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.METAOP) && (tt4.equals("R"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean infix_prefix_meta_operator_56_alt_8(PsiBuilder builder, OPP opp) {
        ...
        String tt5;
        tt5 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.METAOP) && (tt5.equals("!"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean infixish_57_alt_3(PsiBuilder builder, OPP opp) {
        PsiBuilder.Marker marker2;
        marker2 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.ASSIGN_METAOP) {
            builder.advanceLexer();
        } else {
            return false;
        }
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.METAOP) && (tt1.equals("="))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean infixish_non_assignment_meta_58_alt_4(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.BRACKETED_INFIX_INCOMPLETE) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean infixish_non_assignment_meta_58_alt_9(PsiBuilder builder, OPP opp) {
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.INFIX) && (tt3.equals("]"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean infixish_non_assignment_meta_58_alt_10(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.INFIX_FUNCTION) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean initializer_60_alt_5(PsiBuilder builder, OPP opp) {
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.INFIX) && (tt4.equals("="))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean initializer_60_alt_6(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.INITIALIZER_MISSING) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean initializer_60_alt_8(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.NOT_DOTTY) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean initializer_60_alt_11(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.IS_DOTTY) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean initializer_60(PsiBuilder builder) {
        OPP opp;
        opp = null;
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PARSING_INITIALIZER) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean label_65(PsiBuilder builder) {
        ...
        PsiBuilder.Marker marker1;
        marker1 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.LABEL_NAME) {
            builder.advanceLexer();
        } else {
            return false;
        }
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.LABEL_COLON) && (tt1.equals(":"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean longname_colonpairs_67_quant_1(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.LONGNAME_COLONPAIR) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean metachar_68_alt_5(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.SCOPE_DECLARATOR) && (tt2.equals(":"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean metachar_68_quant_10(PsiBuilder builder, OPP opp) {
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_ASSERTION_ANGLE_CLOSE) && (tt4.equals(">"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean metachar_68_alt_11(PsiBuilder builder, OPP opp) {
        ...
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_ASSERTION_ANGLE_OPEN) && (tt3.equals("<"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean metachar_68_quant_15(PsiBuilder builder, OPP opp) {
        String tt6;
        tt6 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_CAPTURE_PARENTHESES_CLOSE) && (tt6.equals(")"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean metachar_68_alt_16(PsiBuilder builder, OPP opp) {
        ...
        String tt5;
        tt5 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_CAPTURE_PARENTHESES_OPEN) && (tt5.equals("("))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean metachar_68_quant_18(PsiBuilder builder, OPP opp) {
        String tt8;
        tt8 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_GROUP_BRACKET_CLOSE) && (tt8.equals("]"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean metachar_68_alt_19(PsiBuilder builder, OPP opp) {
        ...
        String tt7;
        tt7 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_GROUP_BRACKET_OPEN) && (tt7.equals("["))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean metachar_68_alt_20(PsiBuilder builder, OPP opp) {
        ...
        String tt9;
        tt9 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_BUILTIN_CCLASS) && (tt9.equals("."))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean metachar_68_alt_21(PsiBuilder builder, OPP opp) {
        String tt10;
        tt10 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_ANCHOR) && (tt10.equals(")>"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean metachar_68_alt_22(PsiBuilder builder, OPP opp) {
        String tt11;
        tt11 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_ANCHOR) && (tt11.equals("<("))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean metachar_68_alt_23(PsiBuilder builder, OPP opp) {
        ...
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_ANCHOR) && (tt12.equals("\u00BB"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean metachar_68_alt_24(PsiBuilder builder, OPP opp) {
        ...
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_ANCHOR) && (tt13.equals(">>"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean metachar_68_alt_25(PsiBuilder builder, OPP opp) {
        ...
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_ANCHOR) && (tt14.equals("\u00AB"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean metachar_68_alt_26(PsiBuilder builder, OPP opp) {
        ...
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_ANCHOR) && (tt15.equals("<<"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean metachar_68_alt_27(PsiBuilder builder, OPP opp) {
        ...
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_ANCHOR) && (tt16.equals("$"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean metachar_68_alt_28(PsiBuilder builder, OPP opp) {
        ...
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_ANCHOR) && (tt17.equals("$$"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean metachar_68_alt_29(PsiBuilder builder, OPP opp) {
        ...
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_ANCHOR) && (tt18.equals("^"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean metachar_68_alt_30(PsiBuilder builder, OPP opp) {
        ...
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_ANCHOR) && (tt19.equals("^^"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean metachar_68_alt_32(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_VARIABLE_BINDING_INCOMPLETE) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean metachar_68_quant_34(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_VARIABLE_BINDING) {
            builder.advanceLexer();
        } else {
            return false;
        }
        ...
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.INFIX) && (tt20.equals("="))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean metachar_68_alt_35(PsiBuilder builder, OPP opp) {
        ...
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_VARIABLE) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean method_name_70(PsiBuilder builder) {
        ...
        PsiBuilder.Marker marker1;
        marker1 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.ROUTINE_NAME) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean methodop_71_alt_8(PsiBuilder builder, OPP opp) {
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.INVOCANT_MARKER) && (tt1.equals(":"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean mod_ident_72_alt_1(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_MOD_UNKNOWN) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean mod_ident_72_alt_2(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_MOD_INTERNAL) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean mod_internal_73_quant_4(PsiBuilder builder, OPP opp) {
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_MOD_INTERNAL) && (tt3.equals(")"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean mod_internal_73_quant_6(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_MOD_INTERNAL) && (tt2.equals("("))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean mod_internal_73_alt_8(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_MOD_INTERNAL_NUMERIC) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean mod_internal_73_alt_9(PsiBuilder builder, OPP opp) {
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_MOD_INTERNAL) && (tt4.equals("!"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean mod_internal_73(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_MOD_INTERNAL) && (tt1.equals(":"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean module_name_74(PsiBuilder builder) {
        ...
        PsiBuilder.Marker marker2;
        marker2 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.NAME) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean multi_declarator_76_alt_5(PsiBuilder builder, OPP opp) {
        PsiBuilder.Marker marker2;
        marker2 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.MULTI_DECLARATOR) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean multilinecomment_77_quant_1(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.COMMENT_QUOTE_CLOSE) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean multilinecomment_77(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.COMMENT_STARTER) && (tt1.equals("#`"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.COMMENT_QUOTE_OPEN) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean multilinecommentnibbler_78_alt_1(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.COMMENT) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean named_param_80_quant_4(PsiBuilder builder, OPP opp) {
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.NAMED_PARAMETER_SYNTAX) && (tt3.equals(")"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean named_param_80_quant_7(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.NAMED_PARAMETER_SYNTAX) && (tt2.equals("("))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean named_param_80_alt_8(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.NAMED_PARAMETER_NAME_ALIAS) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean named_param_80(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.NAMED_PARAMETER_SYNTAX) && (tt1.equals(":"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean nextterm_81_alt_2(PsiBuilder builder, OPP opp) {
        PsiBuilder.Marker marker2;
        marker2 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.DOTTY_NEXT_TERM) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean nextterm_81_alt_3(PsiBuilder builder, OPP opp) {
        PsiBuilder.Marker marker4;
        marker4 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.NULL_TERM) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean onlystar_87(PsiBuilder builder) {
        ...
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.ONLY_STAR) && (tt2.equals("*"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
        ...
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.BLOCK_CURLY_BRACKET_CLOSE) && (tt3.equals("}"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean package_declarator_88_alt_4(PsiBuilder builder, OPP opp) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TRUSTS) && (tt1.equals("trusts"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean package_declarator_88_alt_8(PsiBuilder builder, OPP opp) {
        ...
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.ALSO) && (tt2.equals("also"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean package_declarator_88_alt_9(PsiBuilder builder, OPP opp) {
        PsiBuilder.Marker marker11;
        marker11 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PACKAGE_DECLARATOR) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean package_def_89_quant_1(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TYPE_PARAMETER_BRACKET) && (tt2.equals("]"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean package_def_89_quant_3(PsiBuilder builder, OPP opp) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TYPE_PARAMETER_BRACKET) && (tt1.equals("["))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean package_def_89_quant_4(PsiBuilder builder, OPP opp) {
        PsiBuilder.Marker marker1;
        marker1 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PACKAGE_NAME) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean param_sep_91(PsiBuilder builder) {
        ...
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PARAMETER_SEPARATOR) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean param_var_93_quant_1(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PARAM_ARRAY_SHAPE) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean param_var_93_quant_5(PsiBuilder builder, OPP opp) {
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.SIGNATURE_BRACKET_CLOSE) && (tt4.equals("]"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean param_var_93_alt_6(PsiBuilder builder, OPP opp) {
        ...
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.SIGNATURE_BRACKET_OPEN) && (tt3.equals("["))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean parameter_94_quant_3(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PARAMETER_QUANTIFIER) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean parameter_94_alt_5(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PARAMETER_INCOMPLETE) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean parameter_94_alt_8(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.IS_PARAM_TERM_QUANT) {
            builder.advanceLexer();
        } else {
            return false;
        }
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PARAMETER_QUANTIFIER) && (tt1.equals("+"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean parameter_94_alt_9(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PARAMETER_QUANTIFIER) && (tt2.equals("|"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean parameter_94_alt_10(PsiBuilder builder, OPP opp) {
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PARAMETER_QUANTIFIER) && (tt3.equals("\\"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean parameter_94_alt_13(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PARAMETER_ANON) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean parameter_94_alt_21(PsiBuilder builder, OPP opp) {
        ...
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PARAMETER_QUANTIFIER) && (tt4.equals("+"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean parameter_94_alt_22(PsiBuilder builder, OPP opp) {
        String tt5;
        tt5 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PARAMETER_QUANTIFIER) && (tt5.equals("|"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean parameter_94_alt_23(PsiBuilder builder, OPP opp) {
        String tt6;
        tt6 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TERM_DECLARATION_BACKSLASH) && (tt6.equals("\\"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean pblock_95_alt_1(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.MISSING_BLOCK) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean pblock_95_alt_4(PsiBuilder builder, OPP opp) {
        PsiBuilder.Marker marker4;
        marker4 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.LAMBDA) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean pod_block_abbreviated_99_quant_2(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.POD_WHITESPACE) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean pod_block_abbreviated_99(PsiBuilder builder) {
        ...
        PsiBuilder.Marker marker1;
        marker1 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.POD_REMOVED_WHITESPACE) {
            builder.advanceLexer();
        } else {
            return false;
        }
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.POD_DIRECTIVE) && (tt1.equals("="))) {
            builder.advanceLexer();
        } else {
            return false;
        }
        ...
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.POD_TYPENAME) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean pod_block_content_100_alt_5(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.POD_TEXT) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean pod_block_content_100_alt_10(PsiBuilder builder, OPP opp) {
        ...
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.POD_CODE) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean pod_block_content_100_quant_14(PsiBuilder builder, OPP opp) {
        ...
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.POD_HAVE_CONTENT) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean pod_block_delimited_101_quant_4(PsiBuilder builder, OPP opp) {
        ...
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.POD_DIRECTIVE) && (tt2.equals("=end"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean pod_block_delimited_101(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.POD_DIRECTIVE) && (tt1.equals("=begin"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean pod_block_finish_102_alt_1(PsiBuilder builder, OPP opp) {
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.POD_DIRECTIVE) && (tt1.equals("=finish"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean pod_block_finish_102_alt_2(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.POD_DIRECTIVE) && (tt2.equals("=for"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
        ...
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.POD_TYPENAME) && (tt3.equals("finish"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean pod_block_finish_102_alt_3(PsiBuilder builder, OPP opp) {
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.POD_DIRECTIVE) && (tt4.equals("=begin"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
        ...
        String tt5;
        tt5 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.POD_TYPENAME) && (tt5.equals("finish"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean pod_block_finish_102(PsiBuilder builder) {
        ...
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.POD_FINISH_TEXT) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean pod_block_paragraph_103(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.POD_DIRECTIVE) && (tt1.equals("=for"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean pod_configuration_105(PsiBuilder builder) {
        ...
        PsiBuilder.Marker marker1;
        marker1 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.POD_CONFIGURATION) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean pod_formatted_text_107_alt_2(PsiBuilder builder, OPP opp) {
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.POD_FORMAT_SEPARATOR) && (tt1.equals("|"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean pod_formatting_code_108_quant_2(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.POD_FORMAT_STOPPER) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean pod_formatting_code_108(PsiBuilder builder) {
        ...
        PsiBuilder.Marker marker2;
        marker2 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.FORMAT_CODE) {
            builder.advanceLexer();
        } else {
            return false;
        }
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.POD_FORMAT_STARTER) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean pod_newline_109(PsiBuilder builder) {
        OPP opp;
        opp = null;
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.POD_NEWLINE) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean post_constraint_114_alt_2(PsiBuilder builder, OPP opp) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.WHERE_CONSTRAINT) && (tt1.equals("where"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean post_constraint_114_quant_5(PsiBuilder builder, OPP opp) {
        String tt5;
        tt5 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.SIGNATURE_BRACKET_CLOSE) && (tt5.equals("]"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean post_constraint_114_alt_6(PsiBuilder builder, OPP opp) {
        ...
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.SIGNATURE_BRACKET_OPEN) && (tt4.equals("["))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean postcircumfix_115_quant_4(PsiBuilder builder, OPP opp) {
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.HASH_INDEX_BRACKET_CLOSE) && (tt4.equals(">"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean postcircumfix_115_alt_6(PsiBuilder builder, OPP opp) {
        ...
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.HASH_INDEX_BRACKET_OPEN) && (tt3.equals("<"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean postcircumfix_115_quant_7(PsiBuilder builder, OPP opp) {
        String tt6;
        tt6 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.HASH_INDEX_BRACKET_CLOSE) && (tt6.equals("\u00BB"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean postcircumfix_115_alt_9(PsiBuilder builder, OPP opp) {
        ...
        String tt5;
        tt5 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.HASH_INDEX_BRACKET_OPEN) && (tt5.equals("\u00AB"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean postcircumfix_115_quant_10(PsiBuilder builder, OPP opp) {
        String tt8;
        tt8 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.HASH_INDEX_BRACKET_CLOSE) && (tt8.equals(">>"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean postcircumfix_115_alt_12(PsiBuilder builder, OPP opp) {
        ...
        String tt7;
        tt7 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.HASH_INDEX_BRACKET_OPEN) && (tt7.equals("<<"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean postcircumfix_115_quant_13(PsiBuilder builder, OPP opp) {
        String tt10;
        tt10 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.HASH_INDEX_BRACKET_CLOSE) && (tt10.equals("}"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean postcircumfix_115_alt_15(PsiBuilder builder, OPP opp) {
        ...
        String tt9;
        tt9 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.HASH_INDEX_BRACKET_OPEN) && (tt9.equals("{"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean postcircumfix_115_quant_16(PsiBuilder builder, OPP opp) {
        String tt12;
        tt12 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.ARRAY_INDEX_BRACKET_CLOSE) && (tt12.equals("]"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean postcircumfix_115_alt_18(PsiBuilder builder, OPP opp) {
        ...
        String tt11;
        tt11 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.ARRAY_INDEX_BRACKET_OPEN) && (tt11.equals("["))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean postfix_116(PsiBuilder builder) {
        OPP opp;
        opp = null;
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.POSTFIX) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean postfixish_117_alt_1(PsiBuilder builder, OPP opp) {
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.WHITE_SPACE) && (tt1.equals("\\"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean postfixish_117_quant_3(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.UNSPACED_POSTFIX) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean postfixish_117_quant_6(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.METAOP) && (tt2.equals("."))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean postfixish_nometa_118_alt_3(PsiBuilder builder, OPP opp) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.METHOD_CALL_OPERATOR) && (tt1.equals("."))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean postfixish_nometa_118_alt_6(PsiBuilder builder, OPP opp) {
        ...
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.POSTFIX) && (tt2.equals("."))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean prefix_121_alt_1(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PREFIX) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean prefix_121_alt_2(PsiBuilder builder, OPP opp) {
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PREFIX) && (tt1.equals("not"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean prefix_121_alt_3(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PREFIX) && (tt2.equals("so"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean prefix_121_alt_4(PsiBuilder builder, OPP opp) {
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PREFIX) && (tt3.equals("temp"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean prefix_121_alt_5(PsiBuilder builder, OPP opp) {
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PREFIX) && (tt4.equals("let"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quantified_atom_124_alt_2(PsiBuilder builder, OPP opp) {
        PsiBuilder.Marker marker3;
        marker3 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_QUANTIFIER) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quantifier_125_alt_4(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_QUANTIFIER_MISSING) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quantifier_125_alt_5(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.WHATEVER) && (tt2.equals("*"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quantifier_125_alt_10(PsiBuilder builder, OPP opp) {
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PREFIX) && (tt3.equals("^"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quantifier_125_alt_12(PsiBuilder builder, OPP opp) {
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_QUANTIFIER) && (tt1.equals("**"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quibble_126_alt_2(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STRING_LITERAL_QUOTE_OPEN) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quibble_rx_127_quant_1(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.QUOTE_REGEX) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_escape_130_alt_2(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STRING_LITERAL_ESCAPE) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_escape_130_alt_3(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.BAD_ESCAPE) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_escape_130_alt_7(PsiBuilder builder, OPP opp) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STRING_LITERAL_REQUOTE_ESCAPE) && (tt1.equals("\\"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_escape_130_alt_12(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.ESCAPE_FUNCTION) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_escape_130_alt_14(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.ESCAPE_HASH) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_escape_130_alt_16(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.ESCAPE_ARRAY) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_escape_130_alt_17(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.BAD_ESCAPE) && (tt2.equals("$"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_escape_130_alt_18(PsiBuilder builder, OPP opp) {
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.BAD_ESCAPE) && (tt3.equals("$"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_escape_130_alt_21(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.ESCAPE_SCALAR) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_interpolation_postfix_131(PsiBuilder builder) {
        OPP opp;
        opp = null;
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.POSTFIX_INTERPOLATIN) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_mod_132(PsiBuilder builder) {
        OPP opp;
        opp = null;
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.QUOTE_MOD) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_qlang_136_alt_6(PsiBuilder builder, OPP opp) {
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STRING_LITERAL_QUOTE_OPEN) && (tt4.equals("\u201E"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_qlang_136_quant_9(PsiBuilder builder, OPP opp) {
        String tt8;
        tt8 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STRING_LITERAL_QUOTE_CLOSE) && (tt8.equals("\""))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_qlang_136_alt_10(PsiBuilder builder, OPP opp) {
        String tt7;
        tt7 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STRING_LITERAL_QUOTE_OPEN) && (tt7.equals("\""))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_qlang_136_alt_12(PsiBuilder builder, OPP opp) {
        String tt9;
        tt9 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STRING_LITERAL_QUOTE_OPEN) && (tt9.equals("\u2019"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_qlang_136_alt_14(PsiBuilder builder, OPP opp) {
        String tt10;
        tt10 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STRING_LITERAL_QUOTE_OPEN) && (tt10.equals("\u201A"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_qlang_136_quant_15(PsiBuilder builder, OPP opp) {
        String tt12;
        tt12 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STRING_LITERAL_QUOTE_CLOSE) && (tt12.equals("\u2019"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_qlang_136_alt_16(PsiBuilder builder, OPP opp) {
        String tt11;
        tt11 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STRING_LITERAL_QUOTE_OPEN) && (tt11.equals("\u2018"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_qlang_136_quant_17(PsiBuilder builder, OPP opp) {
        String tt14;
        tt14 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STRING_LITERAL_QUOTE_CLOSE) && (tt14.equals("'"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_qlang_136_alt_18(PsiBuilder builder, OPP opp) {
        String tt13;
        tt13 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STRING_LITERAL_QUOTE_OPEN) && (tt13.equals("'"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_qlang_136_alt_20(PsiBuilder builder, OPP opp) {
        String tt15;
        tt15 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STRING_LITERAL_QUOTE_SYNTAX) && (tt15.equals("q"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_qlang_136_alt_22(PsiBuilder builder, OPP opp) {
        String tt16;
        tt16 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STRING_LITERAL_QUOTE_SYNTAX) && (tt16.equals("qq"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_qlang_136_alt_24(PsiBuilder builder, OPP opp) {
        String tt17;
        tt17 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STRING_LITERAL_QUOTE_SYNTAX) && (tt17.equals("Q"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_quasi_138(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.QUASI) && (tt1.equals("quasi"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_rxlang_139_alt_5(PsiBuilder builder, OPP opp) {
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.QUOTE_REGEX) && (tt1.equals("s"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_rxlang_139_alt_10(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.QUOTE_REGEX) && (tt2.equals("S"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_rxlang_139_alt_15(PsiBuilder builder, OPP opp) {
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.QUOTE_REGEX) && (tt3.equals("ss"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_rxlang_139_alt_20(PsiBuilder builder, OPP opp) {
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.QUOTE_REGEX) && (tt4.equals("Ss"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_rxlang_139_alt_21(PsiBuilder builder, OPP opp) {
        String tt5;
        tt5 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.QUOTE_REGEX) && (tt5.equals("m"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_rxlang_139_alt_22(PsiBuilder builder, OPP opp) {
        String tt6;
        tt6 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.QUOTE_REGEX) && (tt6.equals("ms"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_rxlang_139_alt_23(PsiBuilder builder, OPP opp) {
        String tt7;
        tt7 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.QUOTE_REGEX) && (tt7.equals("rx"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_rxlang_139_alt_24(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.MISSING_REGEX) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_rxlang_139_quant_26(PsiBuilder builder, OPP opp) {
        String tt9;
        tt9 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.QUOTE_REGEX) && (tt9.equals("/"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_rxlang_139_alt_27(PsiBuilder builder, OPP opp) {
        String tt8;
        tt8 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.QUOTE_REGEX) && (tt8.equals("/"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_tr_140_alt_1(PsiBuilder builder, OPP opp) {
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.QUOTE_REGEX) && (tt1.equals("TR"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quote_tr_140_alt_2(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.QUOTE_REGEX) && (tt2.equals("tr"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quotepair_141_alt_2(PsiBuilder builder, OPP opp) {
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.QUOTE_PAIR) && (tt1.equals(":"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.QUOTE_PAIR) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quotepair_141_alt_3(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.QUOTE_PAIR) && (tt2.equals(":!"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean quotepair_141_alt_4(PsiBuilder builder, OPP opp) {
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.QUOTE_PAIR) && (tt3.equals(":"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean rad_number_146_quant_2(PsiBuilder builder, OPP opp) {
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.RADIX_NUMBER) && (tt3.equals(")"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean rad_number_146_alt_3(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.RADIX_NUMBER) && (tt2.equals("("))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean rad_number_146_quant_4(PsiBuilder builder, OPP opp) {
        String tt5;
        tt5 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.RADIX_NUMBER) && (tt5.equals("]"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean rad_number_146_alt_5(PsiBuilder builder, OPP opp) {
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.RADIX_NUMBER) && (tt4.equals("["))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean rad_number_146_alt_6(PsiBuilder builder, OPP opp) {
        String tt7;
        tt7 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.RADIX_NUMBER) && (tt7.equals("0b"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean rad_number_146_alt_7(PsiBuilder builder, OPP opp) {
        String tt8;
        tt8 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.RADIX_NUMBER) && (tt8.equals("0d"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean rad_number_146_alt_8(PsiBuilder builder, OPP opp) {
        String tt9;
        tt9 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.RADIX_NUMBER) && (tt9.equals("0o"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean rad_number_146_alt_9(PsiBuilder builder, OPP opp) {
        String tt10;
        tt10 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.RADIX_NUMBER) && (tt10.equals("0x"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean rad_number_146_quant_11(PsiBuilder builder, OPP opp) {
        String tt11;
        tt11 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.RADIX_NUMBER) && (tt11.equals(">"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean rad_number_146_alt_12(PsiBuilder builder, OPP opp) {
        String tt6;
        tt6 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.RADIX_NUMBER) && (tt6.equals("<"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
        ...
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.RADIX_NUMBER) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean rad_number_146(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.RADIX_NUMBER) && (tt1.equals(":"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean rat_number_148(PsiBuilder builder) {
        ...
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.RAT_LITERAL) && (tt2.equals(">"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean regex_declarator_149_alt_1(PsiBuilder builder, OPP opp) {
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_DECLARATOR) && (tt1.equals("token"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean regex_declarator_149_alt_2(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_DECLARATOR) && (tt2.equals("rule"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean regex_declarator_149_alt_3(PsiBuilder builder, OPP opp) {
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_DECLARATOR) && (tt3.equals("regex"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean regex_def_150_alt_8(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.ONLY_STAR) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean regex_def_150_quant_9(PsiBuilder builder, OPP opp) {
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.BLOCK_CURLY_BRACKET_CLOSE) && (tt4.equals("}"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean regex_def_150_quant_10(PsiBuilder builder, OPP opp) {
        ...
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.BLOCK_CURLY_BRACKET_OPEN) && (tt3.equals("{"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean regex_nibbler_151_alt_2(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_INFIX) && (tt2.equals("&&"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean regex_nibbler_151_alt_3(PsiBuilder builder, OPP opp) {
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_INFIX) && (tt3.equals("|"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean regex_nibbler_151_alt_4(PsiBuilder builder, OPP opp) {
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_INFIX) && (tt4.equals("||"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean routine_declarator_153_alt_1(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.ROUTINE_DECLARATOR) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean rxq_160_alt_4(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STRING_LITERAL_QUOTE_OPEN) && (tt2.equals("\u201A"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean rxws_165_alt_2(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.UNV_WHITE_SPACE) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean scope_declarator_166_alt_1(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.INCOMPLETE_SCOPED_DECLARATION) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean scope_declarator_166(PsiBuilder builder) {
        ...
        PsiBuilder.Marker marker1;
        marker1 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.SCOPE_DECLARATOR) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean semilist_168_alt_4(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.SEMI_LIST_END) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean sibble_170_alt_8(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.SUBST_ASSIGNISH) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean sigmaybe_172_alt_2(PsiBuilder builder, OPP opp) {
        PsiBuilder.Marker marker2;
        marker2 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_SIGSPACE) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean signature_174_alt_3(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.END_OF_PARAMETERS) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean signature_174_alt_9(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.MISSING_RETURN_CONSTRAINT) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean signature_174_quant_14(PsiBuilder builder, OPP opp) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.RETURN_ARROW) && (tt1.equals("-->"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_179_alt_4(PsiBuilder builder, OPP opp) {
        ...
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.EMPTY_STATEMENT) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_CATCH_181(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt1.equals("CATCH"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_CONTROL_182(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt1.equals("CONTROL"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_QUIT_183(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt1.equals("QUIT"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_default_184(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt1.equals("default"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_for_185(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt1.equals("for"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_given_186(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt1.equals("given"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_if_187_alt_1(PsiBuilder builder, OPP opp) {
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt1.equals("with"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_if_187_alt_2(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt2.equals("if"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_if_187_alt_4(PsiBuilder builder, OPP opp) {
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt3.equals("orwith"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_if_187_alt_5(PsiBuilder builder, OPP opp) {
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt4.equals("elsif"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_if_187_quant_11(PsiBuilder builder, OPP opp) {
        String tt5;
        tt5 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt5.equals("else"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_import_188(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt1.equals("import"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_loop_189_quant_5(PsiBuilder builder, OPP opp) {
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_TERMINATOR) && (tt4.equals(";"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_loop_189_quant_8(PsiBuilder builder, OPP opp) {
        String tt5;
        tt5 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PARENTHESES_CLOSE) && (tt5.equals(")"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_loop_189(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt1.equals("loop"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_need_190(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt1.equals("need"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_no_191(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt1.equals("no"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_repeat_192_alt_2(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt2.equals("until"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_repeat_192_alt_3(PsiBuilder builder, OPP opp) {
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt3.equals("while"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_repeat_192_alt_9(PsiBuilder builder, OPP opp) {
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt4.equals("until"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_repeat_192_alt_10(PsiBuilder builder, OPP opp) {
        String tt5;
        tt5 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt5.equals("while"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_repeat_192(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt1.equals("repeat"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_require_193(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt1.equals("require"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_unless_194(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt1.equals("unless"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_until_195(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt1.equals("until"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_use_196(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt1.equals("use"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_when_197(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt1.equals("when"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_whenever_198(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt1.equals("whenever"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_while_199(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt1.equals("while"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_control_without_200(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_CONTROL) && (tt1.equals("without"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_mod_cond_201(PsiBuilder builder) {
        ...
        PsiBuilder.Marker marker1;
        marker1 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_MOD_COND) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_mod_loop_203(PsiBuilder builder) {
        ...
        PsiBuilder.Marker marker1;
        marker1 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_MOD_LOOP) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_prefix_DOC_206(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PHASER) && (tt1.equals("DOC"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_prefix_do_207(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_PREFIX) && (tt1.equals("do"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_prefix_eager_208(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_PREFIX) && (tt1.equals("eager"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_prefix_gather_209(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_PREFIX) && (tt1.equals("gather"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_prefix_hyper_210(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_PREFIX) && (tt1.equals("hyper"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_prefix_lazy_211(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_PREFIX) && (tt1.equals("lazy"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_prefix_once_212(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_PREFIX) && (tt1.equals("once"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_prefix_phaser_213(PsiBuilder builder) {
        ...
        PsiBuilder.Marker marker1;
        marker1 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.PHASER) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_prefix_quietly_214(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_PREFIX) && (tt1.equals("quietly"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_prefix_race_215(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_PREFIX) && (tt1.equals("race"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_prefix_react_216(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_PREFIX) && (tt1.equals("react"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_prefix_sink_217(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_PREFIX) && (tt1.equals("sink"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_prefix_start_218(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_PREFIX) && (tt1.equals("start"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_prefix_supply_219(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_PREFIX) && (tt1.equals("supply"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statement_prefix_try_220(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STATEMENT_PREFIX) && (tt1.equals("try"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean statementlist_221_quant_1(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.WS_OUTSIDE_LIST) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean term_224_alt_19(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TERM_IS_MULTI) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean term_empty_set_225(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TERM) && (tt1.equals("\u2205"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean term_hyperwhatever_226(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.HYPER_WHATEVER) && (tt1.equals("*"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean term_ident_227(PsiBuilder builder) {
        ...
        PsiBuilder.Marker marker2;
        marker2 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.SUB_CALL_NAME) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean term_now_229(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TERM) && (tt1.equals("now"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean term_onlystar_230(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.ONLY_STAR) && (tt1.equals("{*}"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean term_rand_231(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TERM) && (tt1.equals("rand"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean term_reduce_232(PsiBuilder builder) {
        ...
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.METAOP) && (tt3.equals("]"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean term_self_233(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.SELF) && (tt1.equals("self"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean term_stub_code_234_alt_1(PsiBuilder builder, OPP opp) {
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STUB_CODE) && (tt1.equals("!!!"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean term_stub_code_234_alt_2(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STUB_CODE) && (tt2.equals("???"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean term_stub_code_234_alt_3(PsiBuilder builder, OPP opp) {
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STUB_CODE) && (tt3.equals("..."))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean term_stub_code_234_alt_4(PsiBuilder builder, OPP opp) {
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.STUB_CODE) && (tt4.equals("\u2026"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean term_time_235(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TERM) && (tt1.equals("time"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean term_type_const_236(PsiBuilder builder) {
        ...
        PsiBuilder.Marker marker1;
        marker1 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TYPE_CONST) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean term_whatever_237(PsiBuilder builder) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.WHATEVER) && (tt1.equals("*"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean termseq_240_alt_5(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_MISSING_TERM) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean trait_mod_243_alt_1(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TRAIT_INCOMPLETE) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean trait_mod_243_alt_3(PsiBuilder builder, OPP opp) {
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TRAIT) && (tt1.equals("handles"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean trait_mod_243_alt_6(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TRAIT) && (tt2.equals("returns"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean trait_mod_243_alt_9(PsiBuilder builder, OPP opp) {
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TRAIT) && (tt3.equals("of"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean trait_mod_243_alt_14(PsiBuilder builder, OPP opp) {
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TRAIT) && (tt4.equals("will"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean trait_mod_243_alt_17(PsiBuilder builder, OPP opp) {
        String tt5;
        tt5 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TRAIT) && (tt5.equals("does"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean trait_mod_243_alt_20(PsiBuilder builder, OPP opp) {
        String tt6;
        tt6 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TRAIT) && (tt6.equals("hides"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean trait_mod_243_alt_24(PsiBuilder builder, OPP opp) {
        String tt7;
        tt7 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TRAIT) && (tt7.equals("is"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean tribble_244_alt_4(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TR_DISTINCT_START_STOP) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean tribbler_245_alt_1(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TRANS_CHAR) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean tribbler_245_alt_2(PsiBuilder builder, OPP opp) {
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TRANS_BAD) && (tt1.equals(".."))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean tribbler_245_alt_3(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TRANS_RANGE) && (tt2.equals(".."))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean tribbler_245_alt_5(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TRANS_BAD) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean tribbler_245_alt_6(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TRANS_ESCAPE) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean type_declarator_248_alt_1(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.CONSTANT_ANON) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean type_declarator_248_quant_3(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TERM_DECLARATION_BACKSLASH) && (tt2.equals("\\"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean type_declarator_248_alt_6(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.CONSTANT_MISSING_INITIALIZER) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean type_declarator_248_alt_8(PsiBuilder builder, OPP opp) {
        ...
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TYPE_DECLARATOR) && (tt1.equals("constant"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean type_declarator_248_alt_9(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.SUBSET_ANON) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean type_declarator_248_alt_12(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.SUBSET_INCOMPLETE) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean type_declarator_248_quant_14(PsiBuilder builder, OPP opp) {
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.WHERE_CONSTRAINT) && (tt4.equals("where"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean type_declarator_248_alt_18(PsiBuilder builder, OPP opp) {
        ...
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TYPE_DECLARATOR) && (tt3.equals("subset"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean type_declarator_248_alt_19(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.ENUM_ANON) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean type_declarator_248_alt_24(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.ENUM_INCOMPLETE) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean type_declarator_248_alt_28(PsiBuilder builder, OPP opp) {
        ...
        String tt5;
        tt5 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TYPE_DECLARATOR) && (tt5.equals("enum"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean typename_249_alt_9(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.INCOMPLETE_TYPE_NAME) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean typename_249_alt_10(PsiBuilder builder, OPP opp) {
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TYPE_COERCION_PARENTHESES_CLOSE) && (tt4.equals(")"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean typename_249_quant_11(PsiBuilder builder, OPP opp) {
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.TYPE_COERCION_PARENTHESES_OPEN) && (tt3.equals("("))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean typename_249_quant_14(PsiBuilder builder, OPP opp) {
        ...
        String tt5;
        tt5 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.NAME) && (tt5.equals("of"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean unsp_250(PsiBuilder builder) {
        OPP opp;
        opp = null;
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.UNSP_WHITE_SPACE) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean variable_253_quant_9(PsiBuilder builder, OPP opp) {
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.REGEX_CAPTURE_NAME) && (tt1.equals(">"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean variable_253_alt_10(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.VARIABLE_REGEX_NAMED_CAPTURE) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean variable_253_alt_13(PsiBuilder builder, OPP opp) {
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.WHITE_SPACE) && (tt3.equals("\\"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean variable_253_quant_16(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.SELF_CALL_VARIABLE_ARGS) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean variable_253_alt_18(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.SELF_CALL_VARIABLE) {
            builder.advanceLexer();
        } else {
            return false;
        }
        ...
        PsiBuilder.Marker marker19;
        marker19 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.SELF) {
            builder.advanceLexer();
        } else {
            return false;
        }
        ...
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.METHOD_CALL_OPERATOR) && (tt2.equals("."))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean variable_253_quant_19(PsiBuilder builder, OPP opp) {
        String tt5;
        tt5 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.VARIABLE) && (tt5.equals("]"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean variable_253_alt_21(PsiBuilder builder, OPP opp) {
        ...
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.VARIABLE) && (tt4.equals("&["))) {
            builder.advanceLexer();
        } else {
            return false;
        }
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.INFIX_NOUN_VARIABLE) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean variable_253_alt_22(PsiBuilder builder, OPP opp) {
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.SIMPLE_CONTEXTUALIZER) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean variable_declarator_254_quant_2(PsiBuilder builder, OPP opp) {
        String tt2;
        tt2 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.SHAPE_DECLARATION) && (tt2.equals("}"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean variable_declarator_254_alt_3(PsiBuilder builder, OPP opp) {
        String tt1;
        tt1 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.SHAPE_DECLARATION) && (tt1.equals("{"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean variable_declarator_254_quant_4(PsiBuilder builder, OPP opp) {
        String tt4;
        tt4 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.SHAPE_DECLARATION) && (tt4.equals("]"))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean variable_declarator_254_alt_5(PsiBuilder builder, OPP opp) {
        String tt3;
        tt3 = builder.getTokenText();
        if (((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.SHAPE_DECLARATION) && (tt3.equals("["))) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean version_255(PsiBuilder builder) {
        ...
        PsiBuilder.Marker marker1;
        marker1 = builder.mark();
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.VERSION) {
            builder.advanceLexer();
        } else {
            return false;
        }
    ...
    private boolean vws_257(PsiBuilder builder) {
        OPP opp;
        opp = null;
        if ((builder.getTokenType()) == org.raku.parsing.RakuTokenTypes.VERTICAL_WHITE_SPACE) {
            builder.advanceLexer();
        } else {
            return false;
        }
