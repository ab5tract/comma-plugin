...
import static org.raku.parsing.RakuElementTypes.*;
import static org.raku.parsing.RakuOPPElementTypes.INFIX_APPLICATION;
...
class RakuBlock extends AbstractBlock implements BlockWithParent {
    ...
    public Wrap getWrap() {
        ...
        if (myNode.getTreeParent() != null && myNode.getTreeParent().getPsi() instanceof RakuInfixApplication application &&
            myNode.getElementType() != org.raku.parsing.RakuTokenTypes.NULL_TERM && myNode.getElementType() != RakuElementTypes.INFIX) {
        ...
        if (type == SIGNATURE && myCustomSettings.PARAMETER_ALIGNMENT) {
            ...
            if (infixApp.getOperator().equals(",")) {
                ...
                if (origin instanceof RakuCodeBlockCall)
                    ...
                    (child) -> child.getElementType() != org.raku.parsing.RakuTokenTypes.INFIX && child.getElementType() != org.raku.parsing.RakuTokenTypes.NULL_TERM,
                    Alignment.createAlignment()) : null;
                else
                    return myCustomSettings.ARRAY_ELEMENTS_ALIGNMENT ? Pair.create(
                    (child) -> child.getElementType() != org.raku.parsing.RakuTokenTypes.INFIX && child.getElementType() != RakuTokenTypes.NULL_TERM,
                    Alignment.createAlignment()) : null;
            }
