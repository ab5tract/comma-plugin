...
public class RakuSpellCheckingStrategy extends SpellcheckingStrategy {
    ...
    public Tokenizer<?> getTokenizer(PsiElement element) {
        if (element.getNode().getElementType() == org.raku.parsing.RakuTokenTypes.COMMENT ||
            element.getNode().getElementType() == org.raku.parsing.RakuTokenTypes.POD_FINISH_TEXT ||
