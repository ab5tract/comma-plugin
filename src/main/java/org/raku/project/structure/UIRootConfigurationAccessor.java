...
public class UIRootConfigurationAccessor extends RootConfigurationAccessor {
    ...
    public Sdk getProjectSdk(final @NotNull Project project) {
        return org.raku.project.structure.RakuProjectStructureConfigurable.getInstance(project).getProjectSdksModel().getProjectSdk();
    }
    ...
    public String getProjectSdkName(final @NotNull Project project) {
        ...
        final ProjectSdksModel projectJdksModel = org.raku.project.structure.RakuProjectStructureConfigurable.getInstance(project).getProjectSdksModel();
