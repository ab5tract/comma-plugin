...
public class MissingThingsAnnotator implements Annotator {
    private static final TokenSet T_PAREN_OPEN = TokenSet.create(org.raku.parsing.RakuTokenTypes.PARENTHESES_OPEN);
    private static final TokenSet T_PAREN_CLOSE = TokenSet.create(RakuTokenTypes.PARENTHESES_CLOSE);
    private static final TokenSet T_ARRAY_COMP_OPEN = TokenSet.create(org.raku.parsing.RakuTokenTypes.ARRAY_COMPOSER_OPEN);
    private static final TokenSet T_ARRAY_COMP_CLOSE = TokenSet.create(org.raku.parsing.RakuTokenTypes.ARRAY_COMPOSER_CLOSE);
    private static final TokenSet T_ARRAY_INDEX_OPEN = TokenSet.create(org.raku.parsing.RakuTokenTypes.ARRAY_INDEX_BRACKET_OPEN);
    private static final TokenSet T_ARRAY_INDEX_CLOSE = TokenSet.create(org.raku.parsing.RakuTokenTypes.ARRAY_INDEX_BRACKET_CLOSE);
    private static final TokenSet T_BLOCK_OPEN = TokenSet.create(org.raku.parsing.RakuTokenTypes.BLOCK_CURLY_BRACKET_OPEN);
    private static final TokenSet T_BLOCK_CLOSE = TokenSet.create(org.raku.parsing.RakuTokenTypes.BLOCK_CURLY_BRACKET_CLOSE);
    private static final TokenSet T_RX_GROUP_OPEN = TokenSet.create(org.raku.parsing.RakuTokenTypes.REGEX_GROUP_BRACKET_OPEN);
    private static final TokenSet T_RX_GROUP_CLOSE = TokenSet.create(org.raku.parsing.RakuTokenTypes.REGEX_GROUP_BRACKET_CLOSE);
    private static final TokenSet T_RX_ASS_OPEN = TokenSet.create(org.raku.parsing.RakuTokenTypes.REGEX_ASSERTION_ANGLE_OPEN);
    private static final TokenSet T_RX_ASS_CLOSE = TokenSet.create(org.raku.parsing.RakuTokenTypes.REGEX_ASSERTION_ANGLE_CLOSE);
    private static final TokenSet T_RX_CAP_OPEN = TokenSet.create(org.raku.parsing.RakuTokenTypes.REGEX_CAPTURE_PARENTHESES_OPEN);
    private static final TokenSet T_RX_CAP_CLOSE = TokenSet.create(org.raku.parsing.RakuTokenTypes.REGEX_CAPTURE_PARENTHESES_CLOSE);
