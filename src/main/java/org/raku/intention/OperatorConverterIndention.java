...
public abstract class OperatorConverterIndention implements IntentionAction {
    ...
    protected static @NotNull OperatorResult canBeConverted(Editor editor, PsiFile file) {
        ...
        if (elementType == RakuTokenTypes.INFIX || elementType == org.raku.parsing.RakuTokenTypes.METAOP) {
            // If METAOP with infix is incomplete - ignore it
            if (elementType == org.raku.parsing.RakuTokenTypes.METAOP) {
    ...
    public void invoke(@NotNull Project project, Editor editor, PsiFile file) throws IncorrectOperationException {
        ...
        if (elementUnderCaret.getNode().getElementType() == org.raku.parsing.RakuTokenTypes.METAOP &&
