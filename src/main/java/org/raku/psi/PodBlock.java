...
public interface PodBlock extends PodElement {
    TokenSet POD_CONTENT = TokenSet.create(
      ...
      org.raku.parsing.RakuTokenTypes.POD_TEXT,
      org.raku.parsing.RakuTokenTypes.POD_CODE,
      org.raku.parsing.RakuTokenTypes.POD_NEWLINE);

    @Nullable
    default String getTypename() {
        ASTNode typenameNode = getNode().findChildByType(org.raku.parsing.RakuTokenTypes.POD_TYPENAME);
    ...
    default PodDomNode buildPodDom(PodDomBuildingContext context) {
        ...
        for (ASTNode child : getContent()) {
            ...
            if (child.getElementType() == org.raku.parsing.RakuTokenTypes.POD_NEWLINE) {
                ...
                if (outstandingNewlines == 1) {
                    ...
                    // newlines.
                    if (node instanceof PodDomCode && child.getElementType() == org.raku.parsing.RakuTokenTypes.POD_CODE) {
            ...
            if (node == null) {
                if (child.getElementType() == org.raku.parsing.RakuTokenTypes.POD_CODE) {
            ...
            else if (child.getElementType() == org.raku.parsing.RakuTokenTypes.POD_CODE)
