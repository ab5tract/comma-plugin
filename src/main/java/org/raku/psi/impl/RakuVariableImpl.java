...
public class RakuVariableImpl extends ASTWrapperPsiElement implements RakuVariable {
    ...
    public String getVariableName() {
        ...
        if (varToken == null) {
            if (findChildByType(org.raku.parsing.RakuTokenTypes.REGEX_CAPTURE_NAME) != null) {
                return getText();
            } else {
                return null;
            }
    ...
    public boolean isCaptureVariable() {
        return getNode().findChildByType(org.raku.parsing.RakuTokenTypes.REGEX_CAPTURE_NAME) != null;
    }
